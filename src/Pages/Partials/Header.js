    ...
    <>
        <header id="header" className="header fixed-top d-flex align-items-center">
          ...
          <div className="d-flex align-items-center justify-content-between">
            <Link href="/student/attendance/report/" className="logo d-flex align-items-center">
          ...
          <nav className="header-nav ms-auto">
            <ul className="d-flex align-items-center">
              ...
              <li className="nav-item d-block d-lg-none">
                <a className="nav-link nav-icon search-bar-toggle " href="javascript:void(0)">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                  ...
                  <li className="dropdown-footer">
                    <a href="javascript:void(0)">Show all messages</a>
                  </li>
              ...
              <li className="nav-item dropdown pe-3">
                ...
                <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                  ...
                  <li>
                    <Link to="/student/details/" className="dropdown-item d-flex align-items-center">
                  ...
                  <li>
                    <Link to="/student/login/" onClick={logout} className="dropdown-item d-flex align-items-center">    
